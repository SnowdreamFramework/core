    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Integer[] i = {0};
            ...
            public void onClick(View view) {
                ...
                final float PADDING_21 = DensityUtil.applyDimension(getApplicationContext(),TypedValue.COMPLEX_UNIT_DIP,21F);
                final float PADDING_14 = DensityUtil.applyDimension(getApplicationContext(),TypedValue.COMPLEX_UNIT_DIP,14F);
